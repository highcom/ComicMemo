...
//            findNavController().navigate(R.id.action_comicMemoFragment_to_inputMemoFragment, null)
//            val intent = Intent(this@ComicMemoFragment, InputMemoFragment::class.java)
